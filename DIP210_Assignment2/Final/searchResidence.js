...
document.getElementById("a4").addEventListener("click", function(){localStorage.searchArea=document.getElementById("inputArea").value;
                                                                    localStorage.searchCity=document.getElementById("inputCity").value;
                                                                    localStorage.searchVal = residenceList[0].residenceName; window.location.href = "residence_page.html";
                                                                  });
