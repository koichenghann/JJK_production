...
// this jsvaScript file is required for the login logout funciton as well as initialising all sample data
...
function validateUser(userType){
  if (localStorage.currentUser == "" || localStorage.currentUser == undefined) {
    alert("Please log in to access the system with theese sample account:\n<<<applicant>>>\nusername: jeff\npassword: jeff\n\n<<<officer>>>\nusernme: officer\npassword: officer");
    window.location.href = "login.html";
  }
  else {
    if (userType=="applicant" && (JSON.parse(localStorage.currentUser).applicantID == undefined || JSON.parse(localStorage.currentUser).applicantID == "")) {
      alert("Please log in to access the system with theese sample account:\n<<<applicant>>>\nusername: jeff\npassword: jeff\n\n<<<officer>>>\nusernme: officer\npassword: officer");
      window.location.href = "login.html";
    }
    else if (userType=="officer" && (JSON.parse(localStorage.currentUser).staffID == undefined || JSON.parse(localStorage.currentUser).staffID == "")) {
      alert("Please log in to access the system with theese sample account:\n<<<applicant>>>\nusername: jeff\npassword: jeff\n\n<<<officer>>>\nusernme: officer\npassword: officer");
      window.location.href = "login.html";
    }
  }
